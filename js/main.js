...
const UI_TEXT = {
  en: {
    ...
    'projects.researchProjects': 'Research Projects',
    'projects.openSourceProjects': 'Open Source Projects',
    'projects.githubStars': 'GitHub Stars',
    'projects.githubForks': 'GitHub Forks',
    'projects.filtersAria': 'Project filters',
    'projects.keyword': 'Keyword',
    'projects.keywordPlaceholder': 'Title / Tag / Description',
    'projects.tag': 'Tag',
    'projects.allTags': 'All tags',
    'projects.reset': 'Reset',
    'publications.overviewTitle': 'Publication Overview',
    'publications.journalPapers': 'Journal Papers',
    'publications.intlConferences': "Int'l Conferences",
    'publications.domesticConferences': 'Domestic Conferences',
    'publications.firstAuthor': 'First Author',
    'publications.citations': 'Citations',
    'publications.exportDoc': 'Export DOC',
    'publications.exportCsv': 'Export CSV',
    'publications.exportPdf': 'Export PDF',
    'publications.exportNote': 'You can export the list of papers in DOC / CSV / PDF format.',
    'publications.detailsTitle': 'Publication Details',
    'publications.filtersAria': 'Publication filters',
    'publications.keyword': 'Keyword',
    'publications.keywordPlaceholder': 'Title / Authors / Venue',
    'publications.year': 'Year',
    'publications.allYears': 'All years',
    'publications.firstAuthorOnly': 'First-author only',
    'publications.reset': 'Reset',
    'publications.categoriesAria': 'Publication categories',
    'publications.internationalConfShort': 'International Conf.',
    'publications.domesticConfShort': 'Domestic Conf.',
    'publications.noJournal': 'No journal papers match the current filters.',
    'publications.noIntl': 'No international conference papers match the current filters.',
    'publications.noDomestic': 'No domestic conference papers match the current filters.',
    'awards.overviewTitle': 'Awards Overview',
    'awards.researchPresentation': 'Research Presentation Awards',
    'awards.reviewAwards': 'Review Awards',
    'awards.scholarships': 'Scholarships / Financial Honors',
    'education.academicHistory': 'Academic History',
    'certifications.listTitle': 'Certification List',
    ...
    'contact.scopeTitle': 'Inquiry Scope',
    'contact.scopeDescription': 'I welcome research, engineering, and collaboration inquiries related to computer vision, anomaly detection, industrial AI, representation learning, and practical deep learning systems.',
    'contact.fillAll': 'Please fill in all fields.',
    'contact.unavailable': 'Unable to send message. Please try again later.',
    'contact.waitBeforeSubmit': 'Please wait a few seconds before submitting.',
    'contact.waitBeforeNext': 'Please wait {seconds}s before sending another message.',
  ...
  ja: {
    nav: { index: 'ホーム', about: 'プロフィール', blog: 'ブログ', projects: 'プロジェクト', publications: '論文', awards: '受賞', education: '学歴', certifications: '資格', contact: '連絡先' },
    ...
    'projects.overviewTitle': 'プロジェクト概要',
    'projects.researchProjects': '研究プロジェクト',
    'projects.openSourceProjects': 'オープンソースプロジェクト',
    'projects.githubStars': 'GitHubスター',
    'projects.githubForks': 'GitHubフォーク',
    'projects.filtersAria': 'プロジェクトのフィルター',
    'projects.keyword': 'キーワード',
    'projects.keywordPlaceholder': 'タイトル / タグ / 説明',
    'projects.tag': 'タグ',
    'projects.allTags': 'すべてのタグ',
    'projects.reset': 'リセット',
    'publications.overviewTitle': '論文概要',
    'publications.journalPapers': '学術論文',
    'publications.intlConferences': '国際会議',
    'publications.domesticConferences': '国内会議',
    'publications.firstAuthor': '筆頭著者',
    'publications.citations': '被引用数',
    'publications.exportDoc': 'DOC出力',
    'publications.exportCsv': 'CSV出力',
    'publications.exportPdf': 'PDF出力',
    'publications.exportNote': '論文一覧を DOC / CSV / PDF 形式で出力できます．',
    'publications.detailsTitle': '論文詳細',
    'publications.filtersAria': '論文フィルター',
    'publications.keyword': 'キーワード',
    'publications.keywordPlaceholder': 'タイトル / 著者 / 会議・誌名',
    'publications.year': '年',
    'publications.allYears': 'すべての年',
    'publications.firstAuthorOnly': '筆頭著者のみ',
    'publications.reset': 'リセット',
    'publications.categoriesAria': '論文カテゴリ',
    'publications.internationalConfShort': '国際会議',
    'publications.domesticConfShort': '国内会議',
    'publications.noJournal': '現在のフィルターに一致する学術論文はありません．',
    'publications.noIntl': '現在のフィルターに一致する国際会議論文はありません．',
    'publications.noDomestic': '現在のフィルターに一致する国内会議論文はありません．',
    'awards.overviewTitle': '受賞概要',
    'awards.researchPresentation': '研究発表に関する受賞',
    'awards.reviewAwards': '査読に関する受賞',
    'awards.scholarships': '奨学金・経済的支援',
    'education.academicHistory': '学歴',
    'certifications.listTitle': '資格一覧',
    'contact.formTitle': 'お問い合わせフォーム',
    'contact.website': 'Webサイト',
    'contact.name': 'お名前',
    'contact.email': 'メールアドレス',
    'contact.subject': '件名',
    'contact.message': 'メッセージ',
    'contact.send': '送信する',
    'contact.scopeTitle': 'お問い合わせ内容',
    'contact.scopeDescription': 'コンピュータビジョン，異常検知，産業AI，表現学習，実践的な深層学習システムに関する研究・開発・協業のご相談を歓迎します．',
    'contact.fillAll': 'すべての項目を入力してください．',
    'contact.unavailable': '送信できませんでした．しばらくしてから再度お試しください．',
    'contact.waitBeforeSubmit': '送信前に数秒お待ちください．',
    'contact.waitBeforeNext': '次の送信まで {seconds} 秒お待ちください．',
    'contact.sending': '送信中…',
    'contact.sent': '送信が完了しました．',
    'contact.failed': '送信に失敗しました．しばらくしてから再度お試しください．',
    'education.lab': '研究室',
